...
2. Click on **CeresCoconutMTG**.<br /> → The plugin will open.
...
2. Go to the **Stylesheet (CeresCoconutMTG)** area.
...
**CeresCoconutMTG** allows you to override the templates of **Ceres** with your own content. To do so, enter the code in the template and override the template. In the following, setting up the homepage is explained. Set up the other templates the same way.
